...
func (k Keeper) GetActiveSessionForAddress(ctx sdk.Context, address sdk.AccAddress, subscription uint64, node hub.NodeAddress) (session types.Session, found bool) {
	store := k.Store(ctx)
