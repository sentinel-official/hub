...
type MsgRegisterRequest struct {
	...
	PricePerGigabyte github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,2,rep,name=price_per_gigabyte,json=pricePerGigabyte,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.Coins" json:"price_per_gigabyte"`
	PricePerHour     github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,3,rep,name=price_per_hour,json=pricePerHour,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.Coins" json:"price_per_hour"`
...
func init() {
	...
	proto.RegisterType((*MsgUpdateRequest)(nil), "sentinel.node.v2.MsgUpdateRequest")
	proto.RegisterType((*MsgSetStatusRequest)(nil), "sentinel.node.v2.MsgSetStatusRequest")
	proto.RegisterType((*MsgRegisterResponse)(nil), "sentinel.node.v2.MsgRegisterResponse")
	proto.RegisterType((*MsgUpdateResponse)(nil), "sentinel.node.v2.MsgUpdateResponse")
	proto.RegisterType((*MsgSetStatusResponse)(nil), "sentinel.node.v2.MsgSetStatusResponse")
}
...
var fileDescriptor_69e1d326c62910d7 = []byte{
	...
	,
}
...
func (c *msgServiceClient) MsgUpdate(ctx context.Context, in *MsgUpdateRequest, opts ...grpc.CallOption) (*MsgUpdateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/sentinel.node.v2.MsgService/MsgUpdate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) MsgSetStatus(ctx context.Context, in *MsgSetStatusRequest, opts ...grpc.CallOption) (*MsgSetStatusResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/sentinel.node.v2.MsgService/MsgSetStatus", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MsgService_MsgUpdate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sentinel.node.v2.MsgService/MsgUpdate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_MsgSetStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sentinel.node.v2.MsgService/MsgSetStatus",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (m *MsgRegisterRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PricePerHour) > 0 {
		for iNdEx := len(m.PricePerHour) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.PricePerHour[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.PricePerGigabyte) > 0 {
		for iNdEx := len(m.PricePerGigabyte) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.PricePerGigabyte[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *MsgRegisterRequest) Size() (n int) {
	...
	if len(m.PricePerGigabyte) > 0 {
		for _, e := range m.PricePerGigabyte {
			l = e.Size()
			n += 1 + l + sovMsg(uint64(l))
		}
	}
	if len(m.PricePerHour) > 0 {
		for _, e := range m.PricePerHour {
			l = e.Size()
			n += 1 + l + sovMsg(uint64(l))
		}
	}
...
func (m *MsgRegisterRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PricePerGigabyte", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PricePerGigabyte = append(m.PricePerGigabyte, types.Coin{})
			if err := m.PricePerGigabyte[len(m.PricePerGigabyte)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
			...
			m.PricePerHour = append(m.PricePerHour, types.Coin{})
			if err := m.PricePerHour[len(m.PricePerHour)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
