...
var (
	...
	pattern_QueryService_QueryNodesForProvider_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"sentinel", "providers", "address", "nodes"}, "", runtime.AssumeColonVerbOpt(true)))
