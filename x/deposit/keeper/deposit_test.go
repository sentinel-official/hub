...
func TestKeeper_SendFromDepositToAccount(t *testing.T) {
	...
	err := dk.SendCoinsFromDepositToAccount(ctx, types.TestAddress1, types.TestAddress2, sdk.Coins{})
	require.NotNil(t, err)
	err = dk.SendCoinsFromDepositToAccount(ctx, types.TestAddress1, types.TestAddress2, sdk.Coins(nil))
	require.NotNil(t, err)
	err = dk.SendCoinsFromDepositToAccount(ctx, types.TestAddress1, types.TestAddress2, sdk.Coins{sdk.Coin{"stake", sdk.NewInt(-10)}})
	require.NotNil(t, err)
	err = dk.SendCoinsFromDepositToAccount(ctx, types.TestAddress1, types.TestAddress2, sdk.Coins{sdk.NewInt64Coin("stake", 0)})
	require.NotNil(t, err)
	err = dk.SendCoinsFromDepositToAccount(ctx, types.TestAddress1, types.TestAddress2, sdk.Coins{sdk.NewInt64Coin("stake", 10)})
	require.NotNil(t, err)
...
func TestKeeper_ReceiveFromAccountToDeposit(t *testing.T) {
	...
	err := dk.SendCoinsFromAccountToDeposit(ctx, types.TestAddress1, types.TestAddress2, sdk.Coins{})
	require.Nil(t, err)
	err = dk.SendCoinsFromAccountToDeposit(ctx, types.TestAddress1, types.TestAddress2, sdk.Coins(nil))
	require.Nil(t, err)
	err = dk.SendCoinsFromAccountToDeposit(ctx, types.TestAddress1, types.TestAddress2, sdk.Coins{sdk.Coin{"stake", sdk.NewInt(-10)}})
	require.NotNil(t, err)
	err = dk.SendCoinsFromAccountToDeposit(ctx, types.TestAddress1, types.TestAddress2, sdk.Coins{sdk.NewInt64Coin("stake", 0)})
	require.NotNil(t, err)
	err = dk.SendCoinsFromAccountToDeposit(ctx, types.TestAddress1, types.TestAddress2, sdk.Coins{sdk.NewInt64Coin("stake", 10)})
	require.NotNil(t, err)
