...
var (
	...
	TestBandWidthSignDataNeg          = NewBandwidthSignatureData(hub.NewSubscriptionID(0), 0, TestBandwidthNeg)
	...
	TestBandWidthSignDataZero         = NewBandwidthSignatureData(hub.NewSubscriptionID(0), 0, TestBandwidthZero)
	...
	TestBandWidthSignDataPos1         = NewBandwidthSignatureData(hub.NewSubscriptionID(0), 1, TestBandwidthPos1)
	...
	TestBandWidthSignDataPos2         = NewBandwidthSignatureData(hub.NewSubscriptionID(0), 1, TestBandwidthPos2)
