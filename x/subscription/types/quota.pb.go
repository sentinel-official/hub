...
type Quota struct {
	...
	AllocatedBytes github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,2,opt,name=allocated_bytes,json=allocatedBytes,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"allocated_bytes"`
	ConsumedBytes  github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,3,opt,name=consumed_bytes,json=consumedBytes,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"consumed_bytes"`
}
...
func (*Quota) Descriptor() ([]byte, []int) {
	return fileDescriptor_7f9b9d6bd5fdbe87, []int{0}
}
...
func init() {
	proto.RegisterType((*Quota)(nil), "sentinel.subscription.v2.Quota")
}

func init() {
	proto.RegisterFile("sentinel/subscription/v2/quota.proto", fileDescriptor_7f9b9d6bd5fdbe87)
}

var fileDescriptor_7f9b9d6bd5fdbe87 = []byte{
	...
	0xcf, 0xd3, 0x2f, 0x33, 0xd2, 0x2f, 0x2c, 0xcd, 0x2f, 0x49, 0xd4, 0x2b, 0x28, 0xca, 0x2f, 0xc9,
	0x17, 0x92, 0x80, 0xa9, 0xd2, 0x43, 0x56, 0xa5, 0x57, 0x66, 0x24, 0x25, 0x92, 0x9e, 0x9f, 0x9e,
	0x0f, 0x56, 0xa4, 0x0f, 0x62, 0x41, 0xd4, 0x2b, 0x5d, 0x64, 0xe4, 0x62, 0x0d, 0x04, 0xe9, 0x17,
	0x92, 0xe0, 0x62, 0x4f, 0x4c, 0x49, 0x29, 0x4a, 0x2d, 0x2e, 0x96, 0x60, 0x54, 0x60, 0xd4, 0xe0,
	0x0c, 0x82, 0x71, 0x85, 0xc2, 0xb9, 0xf8, 0x13, 0x73, 0x72, 0xf2, 0x93, 0x13, 0x4b, 0x52, 0x53,
	0xe2, 0x93, 0x2a, 0x4b, 0x52, 0x8b, 0x25, 0x98, 0x40, 0x2a, 0x9c, 0xf4, 0x4e, 0xdc, 0x93, 0x67,
	...
	0x16, 0xeb, 0x79, 0xe6, 0x95, 0x04, 0xf1, 0xc1, 0x8d, 0x71, 0x02, 0x99, 0x22, 0x14, 0xca, 0xc5,
	0x97, 0x9c, 0x9f, 0x57, 0x5c, 0x9a, 0x0b, 0x37, 0x97, 0x99, 0x2c, 0x73, 0x79, 0x61, 0xa6, 0x80,
	0x8d, 0x75, 0x0a, 0x3f, 0xf1, 0x50, 0x8e, 0x61, 0xc5, 0x23, 0x39, 0x86, 0x13, 0x8f, 0xe4, 0x18,
	0x2f, 0x3c, 0x92, 0x63, 0x7c, 0xf0, 0x48, 0x8e, 0x71, 0xc2, 0x63, 0x39, 0x86, 0x0b, 0x8f, 0xe5,
	0x18, 0x6e, 0x3c, 0x96, 0x63, 0x88, 0x32, 0x45, 0x32, 0x18, 0x16, 0x60, 0xba, 0xf9, 0x69, 0x69,
	0x99, 0xc9, 0x99, 0x89, 0x39, 0xfa, 0x19, 0xa5, 0x49, 0xfa, 0x15, 0xa8, 0xa1, 0x0c, 0xb6, 0x2b,
	0x89, 0x0d, 0x1c, 0x66, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0xbb, 0xe9, 0xc5, 0x7b, 0x8b,
	0x01, 0x00, 0x00,
}
...
func (m *Quota) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size := m.ConsumedBytes.Size()
		i -= size
		if _, err := m.ConsumedBytes.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
	...
	dAtA[i] = 0x1a
	{
		size := m.AllocatedBytes.Size()
		i -= size
		if _, err := m.AllocatedBytes.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintQuota(dAtA, i, uint64(size))
	}
...
func (m *Quota) Size() (n int) {
	...
	l = m.AllocatedBytes.Size()
	n += 1 + l + sovQuota(uint64(l))
	l = m.ConsumedBytes.Size()
	n += 1 + l + sovQuota(uint64(l))
	return n
}
...
func (m *Quota) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if err := m.AllocatedBytes.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ConsumedBytes", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.ConsumedBytes.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
