...
func AddGenesisAccountCmd(ctx *server.Context, cdc *codec.Codec, nodeHome, clientHome string) *cobra.Command {
	cmd := &cobra.Command{
...
`,
	...
	cmd.Flags().String(flagClientHome, clientHome, "client's home directory")
